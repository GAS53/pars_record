...
class Main:
    ...
    def send_song(self, song):
        find_music = pyautogui.locateCenterOnScreen(
            self.pictures_di["find_music.png"], confidence=0.7
        )
        ...
        sleep(1)
        all_songs = pyautogui.locateCenterOnScreen(
            self.pictures_di["all_songs.png"], confidence=0.7
        )
    ...
    def del_song(self):
        song = pyautogui.locateCenterOnScreen(
            self.pictures_di["del_song.png"], confidence=0.7
        )
